...
# What causes prices to be high and can we make a model to predict the price.
...
This scatterplot is too broad. We want to shrink the x axis. The average nights is only 7. Let's look at the range between 1 and 100.
